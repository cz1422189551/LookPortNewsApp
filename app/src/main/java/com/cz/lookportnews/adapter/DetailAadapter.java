...
public class DetailAadapter extends CommonRecyclerAdapter<News> {

    private static final String TAG = "DetailAadapter";

    public DetailAadapter(@NonNull Context context, int layoutResId , List<News> data) {
        super(context, layoutResId , data);
    }

    public DetailAadapter(@NonNull Context context, int layoutResId) {
