...
import com.cz.lookportnews.dragrecycler.MyItemTouchHelperCallBack;
import com.cz.lookportnews.dragrecycler.NetControl;
...
public class ChannelActivity extends Activity implements CommonAdapter.OnClickListener, CommonAdapter.OnLongClickListener {
    ...
    public static void start(Context c) {
        Intent intent = new Intent(c, ChannelActivity.class);
    ...
    private void initRecyclerView() {
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                return viewType == MyItemEntity.VIEW_TYPE ? 1 : 3;
            }
        });
